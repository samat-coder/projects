...
class _AddSliderState extends State<AddSlider> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('slider').add(data);
      Navigator.pop(context);

      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('slider Product added successfully')),
      );
        ...
        child: Card(
          ...
          child: Padding(
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  _buildHeader("Slider Product Details"),
